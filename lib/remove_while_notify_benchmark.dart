...
typedef BenchMarkFunction = Future<int> Function({required int listeners});
...
Future<int> thomas2({required final int listeners}) async {
...
Future<int> originalValueNotifier({required final int listeners}) async {
  final c = Completer<void>();
...
Future<int> defaultValueNotifier({required final int listeners}) async {
  final c = Completer<void>();
...
Future<int> customLinkedListValueNotifier({required final int listeners}) async {
  final c = Completer<void>();
...
Future<int> cleverValueNotifier(
    {required final int listeners}) async {
  final c = Completer<void>();
