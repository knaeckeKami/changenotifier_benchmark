...
class TestNotifier extends Thomas2ChangeNotifier {
  void notify() {
    notifyListeners();
  }
...
class HasListenersTester<T> extends Thomas2ValueNotifier<T> {
...
class B extends A with Thomas2ChangeNotifier {
  @override
  void test() {
    notifyListeners();
    super.test();
...
class Counter with Thomas2ChangeNotifier {
